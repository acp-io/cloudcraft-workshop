...
You have a working todo app that can **add** and **display** tasks. Your job: implement three new features.
...
Finished early or want to keep going after the workshop? Try these additional features. There are no TODO markers for these — you'll need to figure out the implementation yourself.
